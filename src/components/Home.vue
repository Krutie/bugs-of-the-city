  ...
  <div class="container">
    <div style="width: 930px; margin: 0 auto;">
      ...
      <div style="background: #FCE4EC; text-align: center; padding: 50px; margin: 50px 0; border-radius: 5px;">
        ...
        <div> Check out same project with 
          <a href="http://bugs-city.surge.sh/#/" target="_blank"> GridStack.js</a>
        </div>
        ...
        <div> Read <strong><a> supporting medium article </a></strong> to learn more. </div>
      </div>
    </div>
  </div>
</template>
